...
$$-\frac{B\rho_0}{4\pi G}\frac{d\rho(r)}{dr}=\frac{\rho(r)^3}{r^2}\int_0^r x^2 \rho(x) dx$$
...
$$\frac{B \rho_0}{\rho(r)^2} \frac{d\rho(r)}{dr} = -4 \pi G \frac{\rho(r)}{r^2} \int_0^r x^2 \rho(x) dx$$
...
$$-\frac{B\rho_0}{4\pi G} a n r^{n-1} = \frac{a^3 r^{3n}}{r^2} \int_0^r x^2 (a x^n) dx$$
